...
GitRemoteResolver.prototype._checkout = function () {
    ...
    this._logger.action('home', resolution.tag || resolution.branch || resolution.commit, {
...
GitRemoteResolver.prototype._slowClone = function (resolution) {
    ...
    .then(cmd.bind(cmd, 'git', ['home', resolution.commit], { cwd: this._tempDir }));
};
...
GitRemoteResolver.prototype._fastClone = function (resolution) {
    ...
    return this._shallowClone().then(function (shallowCloningSupported) {
        ...
        .spread(function (stdout, stderr) {
            ...
            return cmd('git', ['home', resolution.commit], { cwd: that._tempDir });
        }, function (err) {
